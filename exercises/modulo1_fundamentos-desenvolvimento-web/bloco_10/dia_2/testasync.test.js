...
describe('Quando o tipo do animal existe', () => {
  test('Retorne a lista de animais', () => getListAnimals('Dog').then((listDogs) => {
    expect.assertions(2); // espera que haja 2 acertos nos expects
    expect(listDogs[0].name).toEqual('Dorminhoco');
    expect(listDogs[1].name).toEqual('Soneca');
  }));
});
describe('Quando o tipo do animal, não existe', () => {
  test('Retorne a lista de animais', () => getListAnimals('Lion').catch((error) =>
